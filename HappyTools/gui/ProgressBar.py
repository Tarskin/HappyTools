...
class ProgressBar(object):
    def __init__(self, master):
        ...
        self.perc1 = tk.Label(self.bar_window, textvariable=self.calibration_percentage)
        self.perc1.grid(row=0, column=1, padx=25)
        self.progressbar = ttk.Progressbar(self.ft, length=100, mode='determinate')
        ...
        self.perc2 = tk.Label(self.bar_window, textvariable=self.quantitation_percentage)
        self.perc2.grid(row=2, column=1, padx=25)
        self.progressbar2 = ttk.Progressbar(self.ft2, length=100, mode='determinate')
